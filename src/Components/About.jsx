...
import Donation from "../assets/Donation1.png";
  ...
  return (
    <div className="bg-white mt-10 px-6 lg:px-20 flex flex-col lg:flex-row items-center lg:items-start relative">
      ...
      <div>
        ...
        <div className="absolute ml-10 lg:ml-[96px] mt-12  w-[250px] sm:w-[350px] lg:w-[450.07px] h-[250px] sm:h-[350px] lg:h-[450.07px] border-2 border-[rgb(2,100,126)] rounded-3xl transform rotate-[-14deg]">
          ...
          <div className="relative w-full mt-10 md:ml-0 lg:ml-8  ">
              ...
              {/* Text content */}
              <div className="absolute top-40 sm:top-48 lg:top-60 left-[-10px] sm:left-[-20px] lg:left-[-40px] bg-[rgb(2,100,126)] text-white border-white rounded-md border-4 px-4 py-2 w-[120px] sm:w-[140px] lg:w-[164px] h-auto sm:h-auto lg:h-auto shadow-md">
                <h3 className="text-lg lg:text-3xl font-bold mt-2 sm:mt-3">20+</h3>
      ...
      <div className="mt-8 lg:mt-0 lg:ml-20 w-full lg:w-1/2 relative ">
        ...
        <br/>
        <h2 className=" font-semibold text-4xl sm:text-base">
        Your Mission Our Technology
        </h2>
        <p className="text-gray-600 text-xl lg:w-[93%] sm:text-1xl mt-4" style={{lineHeight: '1.7'}}>
