  ...
  return (
    <>
      <div className="bg-[rgb(0,58,73)] text-white relative h-auto lg:h-[80vh]">
        ...
        <div className="absolute top-5 lg:top-[-10px] rounded-xl left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col w-[90%] sm:w-[700px] lg:w-[1100px] h-auto lg:h-[242px] bg-[rgb(2,100,126)] py-8 px-4">
  ...
  <div className='ml-8 sm:ml-16 lg:ml-28'>
    ...
    <div className="flex w-full">
      ...
      <button className="px-6 py-2 bg-white text-teal-700 font-semibold rounded-r-md hover:bg-gray-200">
        ...
        {/* Footer Content */}
        <div className="container mx-auto flex flex-wrap justify-between px-6 pt-48 lg:px-52 items-center gap-20">
          {/* Left Section */}
